...
function renderizarTablaConInsertRow(productos, subtotal, igv, total) {
    ...
    rowTotal.insertCell().innerHTML = `<span class="bg-success p-2 text-white">S/ ${total.toFixed(2)}</span>`;
}
